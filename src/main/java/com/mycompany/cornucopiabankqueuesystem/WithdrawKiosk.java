 ...
 * @author James
 */
public class WithdrawKiosk extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(WithdrawKiosk.class.getName());

    /**
     * Creates new form WithdrawKiosk
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cornucopia union bank");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new WithdrawKiosk().setVisible(true));
    }
